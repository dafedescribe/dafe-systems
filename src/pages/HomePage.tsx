      ...
      <main className="editorial-home mx-auto max-w-[1440px] px-6 pb-20 pt-10 sm:px-12 sm:pb-28 sm:pt-16 lg:px-16">
        <section className="editorial-hero relative border-b border-stone-300 pb-14 sm:pb-20">
          <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="hero-reveal space-y-7 lg:col-span-7">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 font-mono-tech text-[10px] font-semibold uppercase tracking-[0.14em] text-amber-800">
                <span>{t('home.eyebrow')}</span><span className="h-px w-8 bg-amber-800/50" aria-hidden="true" /><span>{t('home.location')}</span>
              </div>
              <h1 className="hero-display max-w-[13ch] font-display font-medium leading-[0.94] tracking-[-0.05em] text-slate-950">I build systems for work that has outgrown manual handling.</h1>
              ...
              <div className="grid max-w-2xl grid-cols-1 gap-3 border-t border-stone-300 pt-5 text-xs text-slate-600 sm:grid-cols-3">
                ...
                <div><span className="block font-mono-tech text-[9px] uppercase tracking-wider text-slate-400">Delivery</span>Ibadan-based, globally available</div>
              </div>
            </div>
        ...
        <section className="grid gap-10 border-b border-stone-300 pb-16 pt-4 sm:pb-20 lg:grid-cols-12 lg:gap-14">
          <div className="lg:col-span-5">
            <div className="space-y-5 lg:sticky lg:top-28">
              <div className="font-mono-tech text-[10px] font-bold uppercase tracking-[0.14em] text-amber-800">Operational point of view</div>
        ...
        <section className="border-b border-stone-300 py-16 sm:py-20">
          <div className="mb-10 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            <div><div className="font-mono-tech text-[10px] font-bold uppercase tracking-[0.14em] text-amber-800">Three ways in</div><h2 className="mt-3 max-w-2xl font-display text-4xl leading-tight tracking-[-0.03em] text-slate-950 sm:text-5xl">Start with the operational problem.</h2></div>
        ...
        <section className="border-b border-stone-300 py-16 sm:py-20">
          <div className="grid gap-8 lg:grid-cols-12">
            <div className="lg:col-span-4">
              <div className="font-mono-tech text-[10px] font-bold uppercase tracking-[0.14em] text-amber-800">Workflow evidence</div>
              <h2 className="mt-3 max-w-md font-display text-4xl leading-tight tracking-[-0.035em] text-slate-950 sm:text-5xl">Systems for the work behind the sale.</h2>
            ...
            <div className="divide-y divide-stone-300 border-t border-stone-300 lg:col-span-8">
              {industrialEvidence.map((project) => (
                <article key={project.slug} className="group py-8 first:pt-6">
                  <div className="grid gap-5 sm:grid-cols-[100px_minmax(0,1fr)]">
                    ...
                    <div>
                      ...
                      <dl className="mt-6 grid gap-4 border-y border-stone-200 py-4 text-xs sm:grid-cols-3">
                        ...
                        <div><dt className="font-mono-tech text-[9px] uppercase tracking-wider text-slate-400">Output</dt><dd className="mt-1.5 leading-relaxed text-slate-700">{project.workflow.output}</dd></div>
                        <div><dt className="font-mono-tech text-[9px] uppercase tracking-wider text-slate-400">Result</dt><dd className="mt-1.5 leading-relaxed text-slate-700">{project.result}</dd></div>
                      </dl>
        ...
        <section className="grid gap-12 border-b border-stone-300 py-16 sm:py-20 lg:grid-cols-12">
          <div className="lg:col-span-4"><div className="font-mono-tech text-[10px] font-bold uppercase tracking-[0.14em] text-amber-800">How I work</div><h2 className="mt-3 max-w-sm font-display text-4xl leading-tight tracking-[-0.035em] text-slate-950">From friction to a maintainable build.</h2></div>
        ...
        <section className="grid gap-8 border-b border-stone-300 py-16 sm:py-20 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-8"><div className="font-mono-tech text-[10px] font-bold uppercase tracking-[0.14em] text-amber-800">Applied technical education</div><h2 className="mt-3 max-w-3xl font-display text-4xl leading-tight tracking-[-0.035em] text-slate-950 sm:text-5xl">Teams learn the workflow, not just the tool.</h2><p className="mt-5 max-w-2xl text-base leading-relaxed text-slate-600">Through AppClick Technology, I teach practical automation, APIs, data handling, and AI-assisted engineering to professionals who need systems literacy they can apply.</p></div>
        ...
        <section className="relative my-16 overflow-hidden bg-slate-950 px-7 py-10 text-white sm:my-20 sm:px-12 sm:py-14">
          ...
          <div className="relative grid gap-8 lg:grid-cols-12 lg:items-end">
            <div className="lg:col-span-8"><div className="font-mono-tech text-[10px] font-bold uppercase tracking-[0.14em] text-amber-400">Start with the real process</div><h2 className="mt-4 max-w-3xl font-display text-4xl leading-tight tracking-[-0.035em] sm:text-5xl">What keeps getting copied, checked, searched, or re-entered?</h2><p className="mt-5 max-w-2xl text-sm leading-relaxed text-slate-300">Describe what happens today. I will help identify where automation is useful, where human control must stay, and the smallest sensible path forward.</p></div>
