...
const english = {
  ...
  'contact.briefRegistered': 'Brief registered.',
  'contact.transmission': 'TRANSMISSION CONFIRMED',
  'contact.refLabel': 'DOSSIER REF',
  'contact.products': 'What do you sell? (Products / Machinery / Line)',
  'contact.markets': 'Target Markets / Regions',
  'contact.copyBrief': 'Copy brief details',
  'contact.copied': 'Copied to clipboard',
  'contact.directRouting': 'DIRECT ROUTING TO DAFE',
